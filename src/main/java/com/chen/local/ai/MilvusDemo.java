...
import com.chen.local.ai.milvus.MilvusClient;
import com.chen.local.ai.milvus.MilvusCollection;
import com.chen.local.ai.milvus.MilvusData;
import com.chen.local.ai.milvus.MilvusSearch;
...
//        data.delete(collectionName, "color in ['red_3314', 'purple_7392']");
        ...
        List<Float> denseVectors = embedding.getTextDenseVectors(searchText);
